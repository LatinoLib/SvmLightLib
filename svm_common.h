...
typedef struct model {
  ...
  double  maxdiff;                            /* precision, up to which this 
						 model is accurate */
  double *td_pred;		/* predictions of transductive learning */
  int     n_td_pred;    /* number of predicitons (equals the number of unlabeled examples) */
} MODEL;
